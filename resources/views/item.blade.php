                ...
                <div class="product product--layout--standard" data-layout="standard">
                    <div class="product__content">
                        ...
                        <div class="product__info">
                            ...
                            <h1 class="product__name">{{$item->product->title}}</h1>
                            ...
                            <ul class="product__meta">
                                ...
                                <li>Производитель: <a href="">{{$item->product->brand->title ?? ""}}</a></li>
                            </ul>
                        </div>
                        <!-- .product__info / end -->
                        <!-- .product__sidebar -->
                                                ...
                                                <li class="reviews-list__item">
                                                    <div class="review">
                                                        <div class="review__content">
                                                            <div
                                                                class="review__author">{{$review->user->firstname}} {{$review->user->lastname}}</div>
        ...
        <div class="block block-products-carousel" data-layout="grid-5" data-mobile-grid-columns="2">
            <div class="container">
                <div class="block-header">
                    <h3 class="block-header__title">Другие товары продавца</h3>
                                ...
                                <div class="block-products-carousel__cell">
                                    <div class="product-card product-card--hidden-actions ">
                                        <button class="product-card__quickview" type="button" data-toggle="modal"
                                                data-target="#productView{{$item->id}}">
                                            <svg width="16px" height="16px">
                                                <use
                                            ...
                                            <div class="product-card__rating">
                                                <div class="product-card__rating-stars">
                                                    <div class="rating">
                                                        <div class="rating__body">
                                                            <star-component
                                                                :rating="{{$item->reviews->pluck('rate')->avg() ?? 5}}"></star-component>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="product-card__rating-legend">
                                                    Просмотров: {{$item->views}}</div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="product-card__buttons">
                                                ...
                                                <like-component
                                                    :item={{ $item->id }}
                                                        :home_url
                                                = "homeUrl"
                                                :favorited="{{ $item->isFavoritedBy() ? 'true' : 'false' }}"
