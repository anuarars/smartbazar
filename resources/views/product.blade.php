                                ...
                                <form class="product__options">
                                    ...
                                    <div class="form-group product__option">
                                        ...
                                        <div class="product__actions">
                                            ...
                                            <button class="btn btn-primary btn-lg update-cart"  product-id="{{$product->id}}">В корзину</button>
                                            </div>
                            ...
                            <div class="product-tabs__pane" id="tab-reviews">
                                <div class="reviews-view">
                                    ...
                                    <form class="reviews-view__form">
                                        <h3 class="reviews-view__header text-center">Оставить отзыв</h3>
                                        <div class="row">
                                            <div class="col-12 col-lg-12 col-xl-12">
                                                ...
                                                <div class="form-group mb-0 d-flex  justify-content-around">
                                                    ...
                                                    <button type="submit" class="btn btn-primary btn-lg">Оставить отзыв</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
