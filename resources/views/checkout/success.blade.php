                ...
                <div class="order-success__meta">
                    <ul class="order-success__meta-list">
                        ...
                        <li class="order-success__meta-item">
                            ...
                            <span class="order-success__meta-value">{{number_format($order->products->sum('price')+1000, 0, ' ', ' ')}} тг.</span>
                        </li>
                        <li class="order-success__meta-item">
                        ...
                        <table>
                            ...
                            <tbody class="order-list__subtotals">
                                <tr>
                                    ...
                                    <td class="order-list__column-total">{{number_format($order->products->sum('price'),0, ' ', ' ')}} тг.</td>
                                </tr>
                                <tr>
                            ...
                            <tfoot class="order-list__footer">
                                <tr>
                                    ...
                                    <td class="order-list__column-total">{{number_format($order->products->sum('price')+1000, 0, ' ', ' ')}} тг.</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
                            ...
                            <div class="address-card__body">
                                ...
                                <div class="address-card__row">
                                    @if (Auth::user()->address)
                                        {{Auth::user()->address->home}}<br>
                                        {{Auth::user()->address->street}}<br>
                                        {{Auth::user()->address->unit}}
                                    @endif
                                </div>
                                <div class="address-card__row">
