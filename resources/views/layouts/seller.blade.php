...
<head>
  ...
  <link rel="stylesheet" href="{{asset('dashboard/bundles/dropzonejs/dropzone.css')}}">
...
<body>
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html"> <img alt="image" src="{{asset("dashboard/img/logo.png")}}" class="header-logo" /> <span
  ...
  <script src="{{asset('dashboard/bundles/dropzonejs/min/dropzone.min.js')}}"></script>
  <script src="{{asset('dashboard/js/page/multiple-upload.js')}}"></script>
  <!-- JS Libraies -->
