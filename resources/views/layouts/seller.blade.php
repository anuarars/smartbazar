...
<head>
  ...
  <link href="{{asset('dashboard/bundles/lightgallery/dist/css/lightgallery.css')}}" rel="stylesheet">
  <!-- Custom style CSS -->
...
<body>
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown active">
              <a href="{{route('seller.company.dashboard')}}" class="nav-link"><i data-feather="monitor"></i><span>Главная</span></a>
            </li>
            <li>
            ...
            <li>
              <a class="nav-link" href="{{route('seller.company.edit')}}">
                  <i data-feather="file"></i>
                  <span>Профиль</span>
              </a>
            </li>
  ...
  <script src="{{asset('dashboard/bundles/lightgallery/dist/js/lightgallery-all.js')}}"></script>
  <!-- Page Specific JS File -->
  <script src="{{asset('dashboard/js/page/light-gallery.js')}}"></script>
  <!-- Page Specific JS File -->
  <!-- Page Specific JS File -->
